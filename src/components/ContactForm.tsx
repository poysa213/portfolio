    ...
    return (
      ...
      <div className="mx-auto w-4/5">
        <form onSubmit={handleSubmit(submitHandler)} noValidate>
          <div className="mb-5">
            <label htmlFor="name" className="mb-3 block text-base font-medium text-[#07074D] dark:text-white">
              Full Name
            </label>
            <input
                      type='text'
          ...
          <div className="mb-5">
            <label htmlFor="subject" className="mb-3 block text-base font-medium text-[#07074D] dark:text-white">
              Subject
            </label>
            <input
                      type='text'
          ...
          <div className="mb-5">
            <label htmlFor="message" className="mb-3 block text-base font-medium text-[#07074D] dark:text-white">
              Message
            </label>
